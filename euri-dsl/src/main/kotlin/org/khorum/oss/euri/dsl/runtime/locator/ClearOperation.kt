...
) : PlaywrightConfig<Locator.ClearOptions>, LocatorOperation {
    override fun process(locator: Locator) {
        locator.clear(toPlaywright())
    }

    override fun toPlaywright(): Locator.ClearOptions = Locator.ClearOptions().also {
        it.force = force
        it.timeout = timeout
    }
}
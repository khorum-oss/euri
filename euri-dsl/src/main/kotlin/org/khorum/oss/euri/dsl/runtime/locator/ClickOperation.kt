...
) : PlaywrightConfig<Locator.ClickOptions>, LocatorOperation {
    override fun process(locator: Locator): Unit = locator.click(toPlaywright())

    override fun toPlaywright(): Locator.ClickOptions = Locator.ClickOptions().also { options ->
        options.setButton(button)
        options.setClickCount(clickCount)

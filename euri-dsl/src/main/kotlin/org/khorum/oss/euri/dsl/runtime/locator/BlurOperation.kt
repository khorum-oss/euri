...
) : PlaywrightConfig<Locator.BlurOptions>, LocatorOperation {

    override fun toPlaywright(): Locator.BlurOptions = Locator.BlurOptions().also { options ->
        options.setTimeout(timeout)
    }

    override fun process(locator: Locator) {
        locator.blur(toPlaywright())
    }
}
...
) : PlaywrightConfig<Locator.FillOptions>, LocatorOperation {
    @TransientDsl
    internal var value: String? = null

    override fun process(locator: Locator) {
        locator.fill(value, toPlaywright())
    }

    override fun toPlaywright(): Locator.FillOptions = Locator.FillOptions().also {
        it.force = force
        it.timeout = timeout
    }
}
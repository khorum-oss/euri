...
import org.khorum.oss.euri.playwright.config.NavigationConfig
import org.khorum.oss.euri.playwright.config.ScreenshotConfig
import org.khorum.oss.euri.playwright.mapping.toNavigateOptions
...
class PageScope(private val page: Page) {
    ...
    fun waitForLoadState(state: com.microsoft.playwright.options.LoadState? = null) {
